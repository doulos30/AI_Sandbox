...
def generate_voltage_data(filename, num_samples=80000, anomaly_rate=0.05):
    with open(filename, 'w') as f:
        ...
        for _ in range(num_samples):
            ...
            voltage = random.uniform(115, 125)  # Normal range
            ...
            if random.random() < anomaly_rate:  # Configurable chance of anomaly
                if random.random() < 0.5:
                    ...
                    voltage = random.uniform(90, 126)  # Anomaly: outside normal range
                anomaly = 1
